...
public class BookProgram {
	public static void main(String[] args) {
		...
		Book win = null;
		// 책 5권의 정보를 입력한다.
		book[0] = new Book("1번책", "작가", "출판사", "장르", 10000, "상세정보 입력하세요 : "); 
		book[1] = new Book("2번책", "작가", "출판사", "장르", 20000, "상세정보 입력하세요 : "); 
		book[2] = new Book("3번책", "작가", "출판사", "장르", 30000, "상세정보 입력하세요 : "); 
		book[3] = new Book("4번책", "작가", "출판사", "장르", 40000, "상세정보 입력하세요 : "); 
		book[4] = new Book("5번책", "작가", "출판사", "장르", 50000, "상세정보 입력하세요 : "); 
